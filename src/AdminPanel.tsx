          ...
          <div className="space-y-6">
            <div className="bg-slate-900 p-8 rounded-[2.5rem] border border-slate-800 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-500 uppercase">Monetag Zone ID</label>
                  <input value={settings.monetagZoneId} onChange={e => setSettings({...settings, monetagZoneId: e.target.value})} className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-500 uppercase">Monetag SDK ID</label>
                  <input value={settings.monetagSdkId} onChange={e => setSettings({...settings, monetagSdkId: e.target.value})} className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3" />
                </div>
                <div className="space-y-2">
