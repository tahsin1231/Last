            ...
            <div className="bg-slate-900 p-8 rounded-[2.5rem] border border-slate-800 space-y-6">
              ...
              <div className="space-y-6 pt-6 border-t border-slate-800">
                ...
                <div className="bg-slate-950 p-6 rounded-3xl border border-slate-800 space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-slate-500 uppercase">Task Link URL</label>
                    <div className="flex gap-2">
                      <input 
                        type="text" 
                        value={newTask.link} 
                      ...
                      <button 
                        ...
                        className="px-6 bg-purple-600 rounded-xl font-bold flex items-center gap-2 hover:bg-purple-700 transition-colors"
                      >
                ...
                <div className="space-y-3">
                  {(settings.tasks || []).map(task => (
                    <div key={task.id} className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-xl flex items-center justify-center border border-blue-500/20 bg-blue-500/10 text-blue-500 font-bold text-xs">
                          LNK
                        </div>
                        <div>
