        ...
        <div className="space-y-8 w-full max-w-xs">
          {settingsLoading ? (
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.3em]">Loading App Settings...</p>
            </div>
          ) : (
              ...
              {error || loadTimeout ? (
                ...
                <div className="space-y-4">
                  <h1 className="text-2xl font-black tracking-tight text-white">
                    {currentSettings.appName || 'BD INCOME'}
                  </h1>
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.3em]">Initializing Session...</p>
                  </div>
                </div>
              )}
            </div>
